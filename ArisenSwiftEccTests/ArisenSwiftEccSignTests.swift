...
class ArisenSwiftEccsignTests: XCTestCase {
    ...
    func test_signWithK1() {
        do {
            ...
            for _ in 1...10 {
                let sig = try ArisenEccSign.signWithK1(publicKey: publicKey, privateKey: privateKey, data: message)
