#
# Be sure to run `pod lib lint ArisenSwiftEcc.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'ArisenSwiftEcc'
  s.version          = '0.2.1'
  s.summary          = 'Elliptical Curve Cryptography (ECC) functions for ARISEN. '
  s.homepage         = 'https://github.com/ARISENIO/arisen-swift-ecc'
  ...
  s.source           = { :git => 'https://github.com/ARISENIO/arisen-swift-ecc.git', :tag => "v" + s.version.to_s }

  s.swift_version         = '5.0'
  s.ios.deployment_target = '11.0'

  s.source_files = 'ArisenSwiftEcc/**/*.{c,h,m,cpp,hpp}',
  		             'ArisenSwiftEcc/**/*.swift'
